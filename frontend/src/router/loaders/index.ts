...
import queryClient, { adminUserDataQuery, attendanceOverviewQuery, checkInHoursQuery, dailyAttendanceQuery, departmentsQuery, moodOverviewQuery, sentimentsComparisonQuery } from "@/api/query"

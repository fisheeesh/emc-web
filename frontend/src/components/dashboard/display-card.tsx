...
export default function DisplayCard({ data, type, isLoading }: Props) {

    return (
        <div className="bg-card border w-1/2 lg:w-full py-5 px-6 lg:py-[62px] rounded-md flex justify-between items-center">
            <div>
                {isLoading ? <Skeleton className="h-10 w-32 rounded-sm" /> : <h1 className="text-2xl lg:text-4xl font-en">{data}</h1>}
